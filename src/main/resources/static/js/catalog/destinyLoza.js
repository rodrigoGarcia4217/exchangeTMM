...
const initComponents = () => {
	$("#editDestinyForm").submit( () => {
		...
		formData.append('destinyLocat', 'Loza');

		formData.append('operation', "UPDATE");

        console.log("Municipio:", $("#reNomMunicipio").val());
        console.log("Colonia:", $("#reNomColonia").val());
...
const openEditPopup = (data) => {
	...
	$.ajax({
		type: "GET",
		url: "destinyLoza/getSingleDestiny",
		data: {
			destinyId : data,
		},
