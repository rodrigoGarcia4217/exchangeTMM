...
const initComponents = () => {
	$("#editDestinyForm").submit( () => {
		...
		formData.append('operation', "UPDATE");
   		...
   		$.ajax({
			type: "POST",
			url: "destinyVilla/updateDestiny",
			cache : false, 
			contentType : false,
			processData : false,
			data : formData,
	...
	$("#createDestinyForm").submit( () => {
		...
		formData.append('idUser', $("#globalUserId").val());
        formData.append('userName', $("#globalUserName").val());
		formData.append('destinyLocat', 'Villa');
...
const openEditPopup = (data) => {
	...
	$.ajax({
		type: "GET",
		url: "destinyVilla/getSingleDestiny",
		data: {
			destinyId : data,
		},
